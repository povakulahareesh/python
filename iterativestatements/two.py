...
# Initialize a counter for male employees
# male_count = 0

# # Print male employee names and count them
...
#     if emp['gender']=='Male':
#         print(emp['ename'])
# # Print the total number of male employees
# print(f"\nTotal number of male employees: {male_count}")
...
# print all the male employee using  for and while
