# for loop ,while loop ,for in ,for of
# note:no do-while loop in python
# no switch



# for i in range(10):  # Loop runs once
#     print("gm")
...
# print  first 10 even number using while loop and for loop 
...
# print first evern numbers using for lop
